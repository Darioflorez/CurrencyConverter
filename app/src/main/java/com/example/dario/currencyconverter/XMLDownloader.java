...
public class XMLDownloader {
    ...
    private static String myTag = "CurrencySites";
     ...
     *
     * @param siteURL - the url of the file to download
     * @param fos - a FileOutputStream to save the downloaded file to.
     ************************************************/
    public static void DownloadFromUrl(String siteURL, FileOutputStream fos) {  //this is the downloader method
        try {

            URL url = new URL(siteURL); //URL of the file
